...
class Auth360Account:
    ...
    def authenticate_account():
        ...
        print("----------------------------------------\n"
            ...
            "\n\n"
            "---------------------------------------->>>>>>>\n")
        client_id = input("Enter your `Application (client) ID`. Found on the 'Overview' page: ")
        print("\n\n"
            "---------------------------------------->>>>>>>\n")
        client_secret = input("Enter your prom`Value`. Found on the "
        ...
        token_location = input("Enter the path to the folder where you want to save the token file: ")
        print("\n\n"
            "----------------------------------------\n"
        ...
        token_backend = FileSystemTokenBackend(token_path=token_location, token_filename='my_token.txt')
